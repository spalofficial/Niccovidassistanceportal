...
<div class="row">
  ...
  <div class="column2" style="background-color:#fffeb3;"><h3><i>Hospital list with bed information.</i></h3>
  <%
  	int count=0;
  	ResultSet rs=HospitalController.getHospitalInfo();
  	out.println("<table border=2><tr> <td><b>Sr No.</b></td> <td><b>Hospital Name</b></td> <td><b>Hospital Address</b></td> <td><b>Contact Person</b></td> <td><b>Contact Number</b></td> <td><b>Covid Bed Type</b></td> <td><b>Total No of Bed</b></td> <td><b>Occupied</b></td> <td><b>Vacant</b></td> </tr>");
        while(rs.next()){
        	count++;
